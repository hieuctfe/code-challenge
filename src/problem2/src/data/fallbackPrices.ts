...
/**
 * A bundled snapshot of https://interview.switcheo.com/prices.json.
 *
 * Used as a graceful fallback so the app still renders when the network is
 * unavailable (offline dev, CI, or a failed request). The live fetch takes
 * precedence when it succeeds.
 */
export const FALLBACK_PRICES: PriceRecord[] = [
  ...
  { currency: 'STOSMO', date: '2023-08-29T07:10:40.000Z', price: 0.431318 },
  ...
  { currency: 'LSI', date: '2023-08-29T07:10:40.000Z', price: 67.69661525423729 },
  ...
  { currency: 'SWTH', date: '2023-08-29T07:10:40.000Z', price: 0.004039850455012084 },
  { currency: 'USC', date: '2023-08-29T07:10:40.000Z', price: 0.994 },
  { currency: 'WBTC', date: '2023-08-29T07:10:40.000Z', price: 26002.82202020202 },
  ...
  { currency: 'ZIL', date: '2023-08-29T07:10:40.000Z', price: 0.01651813559322034 },
]
